...
if (isset($submit)) {
    if ($user === "admind" && $sandi == "admind123") {
...
<body class="flex  justify-center min-h-screen  item-center content-center"    x-data="{ 
...
<div
    ...
    class="relative w-full max-w-sm content-center">
    ...
    <div class="relative w-full mt-2 content">
       ...
       class="relative"
        ...
        pasword: '',
         ...
         disabled() {
            return this.username.trim() !== '' && this.pasword.trim() !== ''  ;
        ...
        >
            ...
            <div class=" rounded-lg shadow-sm bg-card text-neutral-900">
                ...
                <div class="p-6 pt-0 space-y-2">
                    <div class="space-y-1"><label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70" for="name">Username</label><input x-model="username" name="user" type="text" placeholder="Name" id="name" class="flex w-full h-10 px-3 py-2 text-sm bg-white border rounded-md peer border-neutral-300 ring-offset-background placeholder:text-neutral-400 focus:border-neutral-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-400 disabled:cursor-not-allowed disabled:opacity-50" /></div>
                    <div class="space-y-1"><label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70" for="username">Password</label><input  x-model="pasword" name="sandi" type="password" placeholder="Username" id="username"  class="flex w-full h-10 px-3 py-2 text-sm bg-white border rounded-md peer border-neutral-300 ring-offset-background placeholder:text-neutral-400 focus:border-neutral-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-400 disabled:cursor-not-allowed disabled:opacity-50" /></div>
                </div>
                <div class="flex items-center p-6 pt-0"><button  @click="title='Username & Pasword cannot be empty'; type='danger';  !disabled() ? popToast() : ''"  type="submit" name="submit" class="inline-flex items-center justify-center px-4 py-2 text-sm font-medium tracking-wide text-white transition-colors duration-200 rounded-md bg-neutral-950 hover:bg-neutral-900 focus:ring-2 focus:ring-offset-2 focus:ring-neutral-900 focus:shadow-outline focus:outline-none">Login</button></div>
            </div>
            <!-- End Tab Content 1 -->
        </form>
